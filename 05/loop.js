...
/**
 * @description Function to mimic a 'for' loop.
 * @param value The initial value for the loop
 * @param test Function run on value to determine when to exit the function
 * @param update Function used to update the value
 * @param body Function used to mimic the body of a 'for' loop
 */
